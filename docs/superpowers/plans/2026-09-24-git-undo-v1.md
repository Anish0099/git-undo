...
- Module path: **`github.com/anish0099/git-undo`** — rename the `anish` owner segment before publishing; all import paths below use this exact prefix.
...
go mod init github.com/anish0099/git-undo
```
